...
def shut_down():
    ...
    print("Shutting down...")
    os.system("shutdown /s /t 0") #shutting down
    print("Shut down.")
...
root.title("PC automatic shut down by jtw") #window title
root.config(bg="#0f0f0f")
Label(root, text="PC automatic shut down",bg='#0F0F0F',fg='#fafafa' , font='italic 15 bold').pack(pady=10) #first title label
